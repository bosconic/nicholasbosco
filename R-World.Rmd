...
knitr::include_graphics(c("images/monthly_marriage.png"))
...
```{r out.width = "75%", echo = FALSE}
knitr::include_graphics(c("images/hh_size.png"))

```


The final report for the class I had wrote about Polygamy in Senegal during the 1980s. The idea for this report was to link the story, *So Long a Letter* by Mariama Ba, more specifically about the main character's attitudes towards polygamy with the data from the *Senegal DHS 1986* to give some context to why the author of the book was writing about polygamy the way she does, check out [So Long Polygamy](https://github.com/bosconic/SoLongPolygamy).

```{r out.width = "75%", echo = FALSE}
knitr::include_graphics(c("images/polygamous_unions.png"))
